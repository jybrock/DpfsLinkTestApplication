    ...
    public class TCPHeader {
        ...
        public TCPHeader(byte[] byBuffer, int nReceived) {
            try {
                ...
                // The data offset indicates where the data begins.
                // So using it we calculate the header length.
                ...
                MessageBox.Show(ex.Message, "MonitorFormTcP" + (nReceived), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public string AcknowledgementNumber {
            get {
                // If the ACK flag is set then only we have a valid value in the acknowlegement field.
                // So check for it beore returning anything
        ...
        public string UrgentPointer {
            get {
                // If the URG flag is set then only we have a valid value in the urgent pointer field.
                // So check for it beore returning anything.
